...
//    ]
    ...
    static let list = [
        BannerInfo(title: "환어1", description: "Explore international music in many genres.", imageName: "img_music_discover"),
        BannerInfo(title: "환어2", description: "Made just for you, based on your taste.", imageName: "img_music_personalized"),
        BannerInfo(title: "환어3", description: "Download songs to your app and bring them on the go.", imageName: "img_music_download"),
        BannerInfo(title: "환어4", description: "Available on mobile, PC and tablet.", imageName: "img_music_multi_device"),
